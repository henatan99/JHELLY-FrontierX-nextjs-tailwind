...
export default function Home() {
  return (
    <div className='bg-[#0D0D0D] container mx-auto relative w-[100vw] min-h-[100vh] overflow-x-hidden'>
      <Head>
      ...
      <main className={`relative container mx-auto overflow-hidden w-full h-auto z-50`}>
